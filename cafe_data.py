...
URL = "https://github.com/Mpho048/Retail-Data-Cleaning-Pipeline-or-Dirty-Cafe-Analysis."
...
pdf.add_page()
#Preview and Source Code Section, choicing  columns 
preview_df = df[['Transaction ID', 'Item', 'Quantity', 'Price Per Unit', 'Total Spent']].head(5)
pdf.show_info(preview_df, url = URL)
